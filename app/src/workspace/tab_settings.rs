...
define_settings_group!(TabSettings, settings: [
    ...
    show_vertical_tabs_search_bar: ShowVerticalTabsSearchBar {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        private: false,
        toml_path: "appearance.vertical_tabs.show_search_bar",
        description: "Whether to show the top search bar in the vertical tabs header.",
    },
